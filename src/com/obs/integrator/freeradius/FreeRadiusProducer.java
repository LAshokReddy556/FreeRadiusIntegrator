...
public class FreeRadiusProducer implements Runnable {
	...
	public FreeRadiusProducer(Queue<FreeRadiusProcessRequestData> messageQueue1,
	...
	private void setDataForEntitlement(EntitlementsData entitlement) {
		// TODO Auto-generated method stub
		FreeRadiusProcessRequestData m;
		try {
			
			if (entitlement.getProvisioingSystem().equalsIgnoreCase(provisioningSystem))
			 {					
				m = new FreeRadiusProcessRequestData(entitlement.getId(),entitlement.getPrdetailsId(),entitlement.getProvisioingSystem(),
						...
						entitlement.getFirstName(),entitlement.getLastName(),entitlement.getSelfcareUsername(),
						entitlement.getSelfcarePassword(), entitlement.getEmail());
				...
				logger.info(no +") ClientId="+entitlement.getClientId()+" , ClientName = "+entitlement.getFirstName() +" , id= "+ entitlement.getId()+" , ServiceId = "+ entitlement.getServiceId() +" , product/Message = "+"'"+ entitlement.getProduct()+"'"+" , setupboxid/SerialNo/HardWareId ="
						+entitlement.getHardwareId()+" , requestType = "+entitlement.getRequestType() + ", Username ="+entitlement.getSelfcareUsername());
